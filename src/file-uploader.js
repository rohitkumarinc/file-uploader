...
(function($) {
    ...
    $.fn.fileUploader = function(options) {
            ...
            plugin.each(function(i, wrapper) {
                ...
                if (plugin.settings.preloaded.length) {
                    ...
                    for (let i = 0; i < plugin.settings.preloaded.length; i++) {
                        $uploadedContainer.append(createImg(getFileNameFromUrl(plugin.settings.preloaded[i].src), plugin.settings.preloaded[i].id, true));
                    }
        ...
        let getFileNameFromUrl = function(url) {
            ...
            // Handle cases where the filename contains query parameters or fragments
        ...
        let createContainer = function() {
            ...
            // Create the File Uploader container
            let $container = $('<div>', {
                class: 'file-uploader'
            });

            $('<div class="csd_upload"><p>Drag files here or <span class="csd_upload__button">Browse</span></p></div>').appendTo($container);
        ...
        let createImg = function(name, id, preloaded) {
        ...
        let setPreview = function($container, files) {
            ...
            $(files).each(function(i, file) {
                ...
                // Set preview
                $uploadedContainer.append(createImg(file.name, dataTransfer.items.length - 1), false);
